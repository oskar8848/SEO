...
(function($) {
    ...
    document.querySelector('.button.primary').addEventListener('click', function(event) {
        // Prevent the default action (immediate page load)
        event.preventDefault();

        // Apply the transition effect (e.g., scale down the button and change color)
        this.style.transform = 'scale(0.9)';
        this.style.backgroundColor = '#e07b00'; // Darken the color for effect
